  ...
  return (
    <div className={`relative w-full h-screen overflow-hidden bg-black ${className}`}>
      <style jsx>{`
        ...
        @keyframes text-glow {
          0%, 100% { filter: drop-shadow(0 0 15px rgba(0, 150, 255, 0.4)); }
          50% { filter: drop-shadow(0 0 35px rgba(0, 150, 255, 0.7)); }
        }
        ...
        @keyframes neon-pulse {
          0%, 100% { 
            filter: invert(1) drop-shadow(0 0 10px rgba(255, 255, 255, 0.4)) drop-shadow(0 0 20px rgba(255, 255, 255, 0.2)); 
          }
          50% { 
            filter: invert(1) drop-shadow(0 0 25px rgba(255, 255, 255, 0.8)) drop-shadow(0 0 50px rgba(255, 255, 255, 0.4)); 
          }
        }
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        ...
        <div className="text-center gap-0 max-w-5xl mx-auto px-4 flex flex-col items-center">
          ...
          {subtitle && (
            <div className="max-w-3xl mx-auto animate-fade-in-up animation-delay-600 mt-2">
